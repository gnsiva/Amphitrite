...
**** TODO ContourGui/CtrPlotPanel.py
...
**** TODO IesGui/IesCheckboxStates.py
**** DONE IesGui/IesGui.py
**** TODO IesGui/IesPlotPanel.py
**** TODO IesGui/IesSettings.py
**** TODO IesGui/ListCtrlConformationsIes.py
**** TODO IesGui/ListCtrlFilesIes.py
**** TODO IesGui/writeCoordinates.py
**** TODO SpectralAveragingGui/SpectralAveragingGui.py
**** TODO SpectralAveragingGui/SaSettings.py
**** TODO SpectralAveragingGui/SaPlotPanel.py
**** TODO SpectralAveragingGui/ListCtrlFilesSa.py
*** Issues
...
** TODO lib
*** TODO utils.py
*** TODO RawFileProcessor.py
*** TODO RawFileProcessor_v2.py
*** TODO fast_driftscope_image.py
*** TODO paths.py
*** TODO SG.py
*** TODO AmphitriteProcessCppAppOutput.py
*** TODO ProcessImRawFiles.py
** Issues
